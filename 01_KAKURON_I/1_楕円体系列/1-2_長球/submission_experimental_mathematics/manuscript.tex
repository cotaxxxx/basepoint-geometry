...
\caption{Certified local bifurcation picture. The dashed curve represents the leading law $r_*(a)^2=c(a_c-a)$. The coefficient satisfies the certified enclosure $c\in[0.3414,0.4517]$; $0.39474123$ is a non-certified reference-point estimate. The figure is schematic, not a global numerical continuation.}
