...
def phi_partitioned_integral_2d(
    ...
    Explicit bands keep each complex neighborhood away from unnecessarily
    broad trigonometric images and greatly reduce adaptive quadrature cost.
    """
    nphi = 4
    local_tol = tol / 8
    total = acb(0)
...
def main() -> None:
    ...
    if args.mode == "lower":
        ...
        box = cert.closed_interval(171743, 50000, 85872, 25000)
