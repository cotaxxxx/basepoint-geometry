...
def config() -> dict:
    ...
    return {
        ...
        "implementation": {"entrypoint_path": "x", "sources_sha256": {"x": z, model.L3_BPRIME_SOURCE_PATH: z}},
        "stage1_dependency": {},
        "l3_bprime_route": {
            "id": model.L3_BPRIME_ROUTE_ID,
            "policy_id": model.L3_BPRIME_POLICY_ID,
            "path": model.L3_BPRIME_SOURCE_PATH,
            "source_sha256": z,
            "stage1_bprime_member_sha256": model.STAGE1_BPRIME_SOURCE_SHA256,
            "stage1_verify_change_of_variables_sha256": model.STAGE1_VERIFY_CHANGE_SHA256,
            ...
            "python_flint": "0.9.0",
            "dps": 18, "bands": 4,
            "rel_tol": model.dyadic_json(Fraction(1, 1 << 18)),
            "eval_limit": 8000, "depth_limit": 22,
            "max_interval_calls": 1, "max_subdivision_depth": 0,
        ...
        "design_contracts": {
            ...
            "l3_bprime": model.L3_BPRIME_DESIGN_SHA256,
        },
    }
