...
RECEIPT = HERE / "F_LAMBDA_CUSTOM_ACCEPT_GATE_RUN_V1.json"

CONTROL_ID = "CUSTOM_ACCEPT"
EXPECTED_CODE = "FAIL_CUSTOM_PREDICATE_FORBIDDEN"
...
print("CUSTOM_ACCEPT_DIRECT_NATIVE_GATE=PASS")
print("EXPECTED_EXACT_CODE=FAIL_CUSTOM_PREDICATE_FORBIDDEN")
...
receipt = {
    "schema": "flambda-custom-accept-gate-run-v1",
    ...
    "verdict": "CUSTOM_ACCEPT_EXACT_SUBCODE_PASS_NOT_PROMOTED",
}
...
print("VERDICT=CUSTOM_ACCEPT_EXACT_SUBCODE_PASS_NOT_PROMOTED")
