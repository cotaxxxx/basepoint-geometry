#!/usr/bin/env python3
"""Dedicated deterministic NC02b Duffy-formula-runtime-ID gate runner.

This is F_LAMBDA_CONTRACT_V1.1 preexecution infrastructure.

Scope:
- execute the V1.8 gate-unit harness;
- require the real-checker NC02b direct gate to pass;
...
EXPECTED_CODE = "FAIL_DUFFY_FORMULA_RUNTIME_ID"
VERDICT = "NC02b_EXACT_SUBCODE_PASS_NOT_PROMOTED"

REQUIRED_STDOUT_LINES = (
    "NC02b_DIRECT_GATE=PASS",
...
def main() -> int:
    ...
    if head_post != head_pre:
        stop("HEAD changed during NC02b gate")
    if git("status", "--porcelain"):
        stop("SOURCE_TREE_POST dirty")

    receipt = {
        "schema": "flambda-nc02b-duffy-formula-runtime-id-gate-run-v1",
