...
RECEIPT = HERE / "F_LAMBDA_NC10_SIGN_GATE_RUN_V1.json"

CONTROL_ID = "NC10"
EXPECTED_CODE = "FAIL_SIGN_CONTRACT"
...
print("NC10_DIRECT_NATIVE_GATE=PASS")
print("EXPECTED_EXACT_CODE=FAIL_SIGN_CONTRACT")
...
receipt = {
    "schema": "flambda-nc10-sign-gate-run-v1",
    ...
    "contract_expected_code": "FAIL_SIGN",
    "implementation_subcode": "FAIL_SIGN_CONTRACT",
    ...
    "verdict": "NC10_EXACT_SUBCODE_PASS_NOT_PROMOTED",
}
...
print("VERDICT=NC10_EXACT_SUBCODE_PASS_NOT_PROMOTED")
