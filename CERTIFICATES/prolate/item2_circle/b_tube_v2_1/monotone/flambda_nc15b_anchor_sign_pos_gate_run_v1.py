...
RECEIPT = HERE / "F_LAMBDA_NC15B_ANCHOR_SIGN_POS_GATE_RUN_V1.json"

CONTROL_ID = "NC15b"
EXPECTED_CODE = "FAIL_ANCHOR_SIGN_POS"
...
class NC15bInterval:
    lo = checker.Dyadic.from_fraction(Fraction(-2))
    hi = checker.Dyadic.from_fraction(Fraction(-1))
...
class NC15bEvaluator:
    ...
    def _evaluate_exact(*args, **kwargs):
        ...
        return None, NC15bInterval(), evidence


expect_checker_failure(
    lambda: checker._anchor_check(
        evaluator=NC15bEvaluator(),
...
receipt = {
    "schema": "flambda-nc15b-anchor-sign-pos-gate-run-v1",
    "contract": "F_LAMBDA_CONTRACT_V1.1",
    "control_id": CONTROL_ID,
    "method": METHOD,
    "expected_exact_code": EXPECTED_CODE,
    "synthetic_enclosure": "violates_POS",
    ...
    "verdict": "NC15b_EXACT_SUBCODE_PASS_NOT_PROMOTED",
}
...
print("VERDICT=NC15b_EXACT_SUBCODE_PASS_NOT_PROMOTED")
