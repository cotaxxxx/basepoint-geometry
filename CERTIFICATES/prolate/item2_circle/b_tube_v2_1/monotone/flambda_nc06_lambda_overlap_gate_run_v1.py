#!/usr/bin/env python3
"""Dedicated deterministic NC06 lambda-overlap dry-precheck runner.

Executes the frozen historical checker's exact lambda-geometry
reconstruction predicate with a synthetic exact-rational overlap between
...
RECEIPT = HERE / "F_LAMBDA_NC06_LAMBDA_OVERLAP_GATE_RUN_V1.json"
...
METHOD = "REAL_CHECKER_LAMBDA_GEOMETRY_DRY_PRECHECK_EXACT_OVERLAP"
VERDICT = "NC06_EXACT_OVERLAP_SUBCODE_PASS_NOT_PROMOTED"
...
#
# NC06 overlaps the exact rational interval (1/16, 3/32) between adjacent
# tile interiors by moving only the first tile's right endpoint to 3/32.
config = {
    "max_cells": 1,
    "blocal_dependency": {
...
receipt = {
    "schema": "flambda-nc06-lambda-overlap-gate-run-v1",
    "contract": "F_LAMBDA_CONTRACT_V1.1",
    "control_id": CONTROL_ID,
    "method": METHOD,
    "mutation": "PRODUCER_GEOMETRY:lambda_overlap",
    ...
    "overlap": {
        ...
        "hi": "3/32",
        "width": "1/32",
        "property": "exact_rational_overlap_between_adjacent_lambda_tile_interiors",
    },
    "positive_parent": {
        "lo": "0",
        "hi": "1/8",
...
print("MUTATION=PRODUCER_GEOMETRY:lambda_overlap")
print("OVERLAP=(1/16,3/32)")
